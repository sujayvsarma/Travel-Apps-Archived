/*
    ...
    About this file: This script defines the NetFxDate type
...
class NetFxDate {
     ...
     * @param {string|Date|NetFxDate} dt - Date as a string or Javascript Date object. Format is of two types: 'MMM dd, yyyy' and 'yyyy-MM-ddZHH:mm:ss'
     */
    constructor(dt) {
        if (dt === null) {
            this._date = new Date();
        ...
        else if ((typeof dt === 'object') && (dt instanceof NetFxDate)) {
     ...
     * @param {number} days
     * @returns {NetFxDate} - The new date
     */
    AddDays(days) {
