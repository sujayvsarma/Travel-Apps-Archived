...
namespace SujaySarma.Web.TravelWeb.Data
{
    ...
    public class Coordinate
    {
        ...
        public Coordinate(string coordinates)
        {
            ...
            {
                throw new ArgumentException("Coordinate string must contain (lat,lon) pair.", nameof(coordinates));
            }

            int sep = coordinates.IndexOf(',');
            Latitude = Convert.ToDouble(coordinates[0..sep]);
            Longitude = Convert.ToDouble(coordinates[(sep + 1)..]);
        }
